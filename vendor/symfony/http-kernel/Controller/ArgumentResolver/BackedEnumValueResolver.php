...
class BackedEnumValueResolver implements ArgumentValueResolverInterface, ValueResolverInterface
{
    ...
    public function supports(Request $request, ArgumentMetadata $argument): bool
    {
        ...
        // letting the \Symfony\Component\HttpKernel\Controllers\ArgumentResolver\DefaultValueResolver be used
        // or \Symfony\Component\HttpKernel\Controllers\ArgumentResolver fail with a meaningful error.
